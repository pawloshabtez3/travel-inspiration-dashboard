  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 lg:bottom-8 lg:right-8 z-50 bg-gradient-to-r from-pink-500 to-red-500 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-full sm:w-96 lg:w-[350px] bg-white shadow-2xl z-50 overflow-hidden flex flex-col"
            >
              {/* Header */}
